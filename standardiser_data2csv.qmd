...
Page de documentation va s'articuler en deux temps : 1=comprendre les enjeux de cette standardisation (théorie) ; 2=comment mener à bien cette standardisation
...
| valo:hasAxe | Dict. personnalisé | Les axes de recherche du laboratoire. | ID Oméka* | Labos_Paris8 → "Axes de recherche" |
