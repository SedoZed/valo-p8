...
Hors recherche, la liste est triée par `o:id` décroissant — donc les items créés le plus récemment en premier. L'ordre n'est pas arbitraire, il en a juste l'air.
:::
