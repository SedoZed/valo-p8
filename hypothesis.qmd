...
Une fois l’extension installée, il suffit de l’activer sur la page web que vous souhaitez annoter en cliquant sur l'icone d'Hypothes.is.
...
**Étape n°1** : D'abord, s'assurer que Hypothes.is est bien lancé en vérifiant si le menu à droite de l'écran peut s'ouvrir. Si ce n'est le cas, cliquez sur l'icone de l'extension pour la démarrer ou assurez vous que [votre URL est correctement modifié](#accéder-à-linterface-de-hypothes.is)).
...
## Protocole d'utilisation pour le projet CartoExpert

### Pour le personnel en général :

### Pour l'opérateur chargé du maintien de CartoExpert :
